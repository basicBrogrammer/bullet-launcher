...
<video
  src="https://github.com/basicBrogrammer/bullet-launcher/releases/download/media-walkthrough/guided-walkthrough.mp4"
  poster="artifacts/media/guided-walkthrough.gif"
  controls
  muted
  loop
  playsinline
  width="360">
  <img src="artifacts/media/guided-walkthrough.gif" alt="Guided walkthrough — daily log, rapid logging, home apps, and gestures" width="360" />
</video>
